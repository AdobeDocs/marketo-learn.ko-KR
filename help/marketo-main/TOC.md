...
+ 기본 사항 {#fundamentals}
   ...
   + [구매자 성향](/help/fundamentals/buyer-personas-learn.md)
...
+ 이메일 마케팅 {#email-marketing}
   ...
   + [예약된 이메일 안내](/help/email-marketing/scheduled-email-watch.md)
   ...
   + [제한된 컨텐츠 오퍼 둘러보기](/help/email-marketing/gated-content-offer-watch.md)
   ...
   + [전자 메일 게재 기능](/help/email-marketing/email-deliverability-learn.md)
   + [이메일 게재 기능 둘러보기](/help/email-marketing/email-deliverability-watch.md)
   + [트리거된 이메일](/help/email-marketing/triggered-email-learn.md)
   + [트리거된 이메일 안내](/help/email-marketing/triggered-email-watch.md)
   + [리드 교육](/help/email-marketing/lead-nuturing-learn.md)
...
+ 다이내믹 채팅 {#dynamic-chat}
   + [다이내믹 채팅 자습서](/help/dynamic-chat/dynamic-chat-overview.md)
   + [제품 투어](/help/dynamic-chat/product-tour.md)
   ...
   + [15분 후에 라이브로 이동](/help/dynamic-chat/go-live-in-15-minutes.md)
   + [대화에 PDF 포함](/help/dynamic-chat/document-cloud-integration.md)
   + [스트림 디자이너에서 검색](/help/dynamic-chat/search-in-stream-designer.md)
   + [추론된 속성 캡처](/help/dynamic-chat/capture-inferred-attributes.md)
   + [대화 상자 미리 보기](/help/dynamic-chat/dialogue-preview.md)
   + [참여도 보고](/help/dynamic-chat/engagement-report.md)
   + [정적 컨텐츠의 세계화](/help/dynamic-chat/globalization-of-static-content.md)
...
+ Sales Insight 작업 {#sales-insight-actions}
   ...
   + [영업 활동 로깅 구성 [!DNL Salesforce]](/help/sales-insight-actions/configure-sales-activity-logging-to-salesforce.md)
+ 리드 및 데이터 관리 {#lead-and-data-management}
   + [리드 점수](/help/lead-and-data-management/lead-scoring-learn.md)
   + [리드 점수 둘러보기](/help/lead-and-data-management/lead-scoring-watch.md)
...
+ 인스턴스 관리 {#instance-management}
   ...
   + [모범 사례 둘러보기](/help/instance-management/best-practice-watch.md)
+ 이벤트 {#events}
