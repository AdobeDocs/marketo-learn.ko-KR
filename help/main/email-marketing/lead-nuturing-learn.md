---
title: '[!UICONTROL lead] 육성 캠페인을 만들고 실행하는 방법에 대해 알아보기'
...
# [!UICONTROL lead] 육성 캠페인을 만들고 실행하는 방법에 대해 알아보기

[!UICONTROL person nurturing]을(를) 사용하면 고유한 구매자 여정 전반에 걸쳐 개인의 요구 사항을 듣고 적절한 콘텐츠로 응답할 수 있습니다. 육성 프로그램, 작동 방식 및 성공을 위한 단계에 대해 알아봅니다.
