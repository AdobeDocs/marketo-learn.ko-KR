---
title: Marketo Engage에서 중복 레코드를 식별하고 방지합니다.
...
# Marketo Engage에서 중복 레코드를 식별하고 방지합니다.

구조화된 워크플로우 및 정기 감사를 통해 중복을 발견하고 방지할 수 있는 도구와 팁을 살펴보십시오.

>[!VIDEO](https://video.tv.adobe.com/v/3447105/?captions=kor&learn=on&enablevpops)
