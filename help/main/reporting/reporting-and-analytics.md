---
title: 보고 및 분석
description: Marketo Engage에서 기본 제공되는 다양한 보고서를 가져오기 위해 Analytics 및 데이터베이스 섹션을 탐색하는 방법에 대해 알아봅니다.
role: User
level: Beginner
...
Marketo Engage에서 기본 제공되는 다양한 보고서를 가져오기 위해 Analytics 및 데이터베이스 섹션을 탐색하는 방법에 대해 알아봅니다.
