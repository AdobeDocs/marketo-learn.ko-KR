...
* 개요
   ...
   * **[빠른 제품 둘러보기 [2022]](product-tour.md)**
     *전체 제품에 대한 개요를 확인하고 [!UICONTROL Dynamic Chat]을(를) 활용하는 방법을 알아보세요.*
   * **[15분 후에 실행](go-live-in-15-minutes.md)**
     *15분 안에 [!UICONTROL Dynamic Chat]를 사용하여 첫 번째 대화 상자를 시작하는 데 도움이 되는 단계별 안내서입니다!*
* 설정
   * **[챗봇 설정 및 설치](setup.md)**
...
* 자동화된 채팅
   * **[개인 맞춤화된 대화 상자 생성 및 관리](dialogue-management.md)**
     *웹 방문자를 빠르게 참여시키기 위한 대화 상자를 만드는 방법에 대해 알아봅니다. [!UICONTROL Dynamic Chat].*
   * **[대화에 PDF 포함](document-cloud-integration.md)**
     *사용자가 [!UICONTROL PDF]에서 디자인한 개인 맞춤화된 대화 내에서 Dynamic Chat 문서 공유*
   ...
   * **[대화 SDK](conversations-sdk.md)**
     *CTA 클릭을 매력적인 대화로 전환하기 위해 대화 SDK을 구현하는 방법에 대해 알아봅니다.*
   ...
   * **[대화형 랜딩 페이지](conversational-landing-pages.md)**
     *몇 번의 클릭만으로 모든 랜딩 페이지(Marketo 랜딩 페이지 또는 사용자 지정)에 Dynamic Chat 대화 흐름을 설치하고 링크 또는 단추를 전환하여 대화 참여를 트리거합니다.*
* 라이브 채팅 및 모임 예약
